...
export function Footer({ site, hotels }: FooterProps) {
  ...
  const s = site;
  const brandLogo = mediaUrl(s?.brand_logo);
        ...
        <div className="container wide">
          <div className="footer-grid">
            <div className="footer-brand">
              <Link href="/" className="brand light" aria-label="Chancery Hotels — home">
                {brandLogo ? (
                  <img src={brandLogo} alt="Chancery Hotels" className="footer-logo" />
                ) : (
                  <>
            ...
            <div className="footer-col">
              ...
              <p className="footer-links column">
                ...
                <Link href="/catering">Outdoor Catering</Link>
